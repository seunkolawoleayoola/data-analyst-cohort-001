...
- **Note:** Plain English for the credit committee: 4% of applicants fall below the 600 automatic decline threshold. Raising the threshold to 620 would decline 8.2% of applicants but reduce default exposure in the borderline band.

### Clean and validate: Normal distribution, z-scores, probability, and the 68-95-99.7 rule

**What I did**

- **Note:** BP of 120mmHg is assume data entry error (z= +5.86) which need clinical confirmation. The probability of this occurring in our dataset is 0.0000002%.
- **Note:** BP of 58mmHg is unusual but possible (z= -5) will be flag for clinical review. The probability of this occurrence is 99.999%.
